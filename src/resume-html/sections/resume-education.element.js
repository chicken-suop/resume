...
${index === 0 ? `<header id="resume-educations-section-header" class="${clsx('tw-mb-1.5 tw-text-3xl tw-font-black')}">Education</header>` : ''}
<a
href="${url}"
target="_blank"
 >
...
<p class="${clsx('tw-text-xl tw-font-regular tw-text-primary')}">${studyType} ${area}</p>
