  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <header class="masthead">
        ${resumeBasic.picture ? `<img src="${resumeBasic.picture}" alt="${resumeBasic.name}" />` : ''}
        <div>
        ...
        <ul class="icon-list">
          ...
          ${
            ...
            <li>
              ...
              <a href="tel:${resumeBasic.phone}">${`${resumeBasic.phone.slice(0, 3)} ${resumeBasic.phone.slice(3, 7)} ${resumeBasic.phone.slice(7, 10)} ${resumeBasic.phone.slice(10, 13)}`}</a>
            </li>
          `
              : ''
          }
